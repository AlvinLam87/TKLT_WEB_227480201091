<?php
// Simulated data for Khoa Kinh tế và Luật organizational structure
$structure = [
    "Trưởng khoa" => "TS. Nguyễn Văn S",
    "Phó trưởng khoa" => "ThS. Trần Thị T",
    "Bộ môn Kinh tế" => ["ThS. Lê Văn U", "ThS. Phạm Thị V"],
    "Bộ môn Luật" => ["TS. Hồ Văn W", "ThS. Nguyễn Thị X"]
];
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    ...
    <title>Cơ cấu tổ chức - Khoa Kinh tế và Luật</title>
...
<body>
    <div class="container">
        ...
        <main>
            <h2>Cơ cấu tổ chức - Khoa Kinh tế và Luật</h2>
            <ul>
