...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['nhanvien_id']) && isset($_POST['luong_co_ban']) && isset($_POST['thuong'])) {
    ...
    if ($employee_exists && $luong_co_ban >= 0 && $thuong >= 0) {
        ...
        $success_message = "Cập nhật hồ sơ lương thành công cho nhân viên ID: $nhanvien_id.";
    } else {
...
<head>
    ...
    <title>Cập nhật hồ sơ lương nhân viên</title>
    ...
    <div class="container">
        ...
        <nav class="sidebar">
            ...
            <ul>
                ...
                <li><a href="cap_nhat_ho_so_luong.php" class="active"><i class="fas fa-sync-alt"></i>Cập nhật hồ sơ</a></li>
        ...
        <main>
            <h2>Cập nhật hồ sơ lương nhân viên - Tháng <?php echo $current_month; ?>/<?php echo $current_year; ?></h2>
            <form action="cap_nhat_ho_so_luong.php" method="post">
                <p>
                ...
                <p>
                    ...
                    <input type="number" name="luong_co_ban" min="0" step="1000" required>
                </p>
                <p>
                    <label>Thưởng (VND):</label>
                    <input type="number" name="thuong" min="0" step="1000" required>
                </p>
