<?php
// Simulated data for Khoa NN&TS organizational structure
$structure = [
    "Trưởng khoa" => "TS. Lê Văn M",
    "Phó trưởng khoa" => "ThS. Nguyễn Thị N",
    "Bộ môn Nông nghiệp" => ["ThS. Trần Văn O", "ThS. Phạm Thị P"],
    "Bộ môn Thủy sản" => ["TS. Hồ Văn Q", "ThS. Lê Thị R"]
];
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    ...
    <title>Cơ cấu tổ chức - Khoa NN&TS</title>
...
<body>
    <div class="container">
        ...
        <main>
            <h2>Cơ cấu tổ chức - Khoa NN&TS</h2>
            <ul>
