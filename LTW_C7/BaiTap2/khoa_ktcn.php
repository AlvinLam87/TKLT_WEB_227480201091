<?php
// Simulated data for Khoa KT & CN (assumed as Khoa CNTT) organizational structure
$structure = [
    "Trưởng khoa" => "TS. Nguyễn Văn A",
    "Phó trưởng khoa" => "PGS.TS. Trần Thị B",
    "Bộ môn Công nghệ thông tin" => ["ThS. Lê Văn C", "ThS. Phạm Thị D"],
    "Bộ môn Kỹ thuật phần mềm" => ["TS. Nguyễn Văn E", "ThS. Hồ Thị F"]
];
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    ...
    <title>Cơ cấu tổ chức - Khoa KT & CN</title>
...
<body>
    <div class="container">
        ...
        <main>
            <h2>Cơ cấu tổ chức - Khoa KT & CN (CNTT)</h2>
            <ul>
                <?php foreach ($structure as $position => $person): ?>
                    <li>
                        <strong><?php echo $position; ?>:</strong>
                        <?php echo is_array($person) ? implode(", ", $person) : $person; ?>
                    </li>
                <?php endforeach; ?>
            </ul>
        </main>
