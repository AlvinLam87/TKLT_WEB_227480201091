<?php
// Simulated data for Khoa Sư phạm organizational structure
$structure = [
    "Trưởng khoa" => "TS. Phạm Văn G",
    "Phó trưởng khoa" => "ThS. Nguyễn Thị H",
    "Bộ môn Toán học" => ["ThS. Trần Văn I", "ThS. Lê Thị J"],
    "Bộ môn Ngữ văn" => ["TS. Hồ Văn K", "ThS. Phạm Thị L"]
];
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    ...
    <title>Cơ cấu tổ chức - Khoa Sư phạm</title>
...
<body>
    <div class="container">
        ...
        <main>
            <h2>Cơ cấu tổ chức - Khoa Sư phạm</h2>
            <ul>
