            ...
            <table>
                ...
                <?php foreach ($employees as $employee): ?>
                    <tr>
                        ...
                        <td><?php echo $employee['chuc_vu']; ?></td>
                        <td><?php echo $employee['don_vi']; ?></td>
                        <td><?php echo $employee['ngay_sinh']; ?></td>
                        <td><?php echo $employee['dia_chi']; ?></td>
                        <td><?php echo $employee['ngay_tao']; ?></td>
                    </tr>
                <?php endforeach; ?>
            </table>
        </main>
